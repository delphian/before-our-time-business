...
{    
    public class ScriptLibTerminalMessage : ScriptLib, IScriptLib
    {
        public ScriptLibTerminalMessage(IConfigurationRoot config, IServiceProvider provider, IApi api, IScriptEngine engine)
